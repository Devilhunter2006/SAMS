...
Route::post('/assign-subjects', [AttendanceController::class, 'storeAssign'])->name('assign.subjects.store');
...
Route::post('/logout', function () {
    ...
    return redirect()->route('staff.login'); // or route('select.login') depending on flow
})->name('logout');
...
Route::get('/attendance/{subjectId?}', [AttendanceController::class, 'index'])->name('attendance.subject');
